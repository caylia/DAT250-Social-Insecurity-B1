...
def index():
    ...
    if form.login.validate_on_submit():
        ...
        query_db('INSERT INTO Users (username, first_name, last_name, password) VALUES("{}", "{}", "{}", "{}");'.format(form.register.username.data, form.register.first_name.data,
                                                                                                                        form.register.last_name.data, hash))
...
def stream():
    ...
    user = query_db('SELECT * FROM Users WHERE id="{}";'.format(curr_user_id), one=True)
...
def comments(p_id):
    ...
    if form.validate_on_submit():
        user = query_db(
            'SELECT * FROM Users WHERE username="{}";'.format(session['username']), one=True)
